...
/* ============================================================
   GLYPH MATRIX — fond animé de glyphes qui mutent doucement.
   Adapté de Magic UI, sans next-themes (Suzanne = light mode).
   Rendu en canvas, ultra-léger, purement décoratif.
   ============================================================ */
...
export function GlyphMatrix({
  ...
  // Résout la couleur CSS en RGBA via un canvas sonde.
  useEffect(() => {
